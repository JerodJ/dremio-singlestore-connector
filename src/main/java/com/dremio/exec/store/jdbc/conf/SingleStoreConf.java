...
@SourceType(value = "SingleStoreARP", label = "SingleStore",uiConfig = "singlestore-layout.json")
public class SingleStoreConf extends AbstractArpConf<SingleStoreConf> {
  ...
  private static final String DRIVER = "cdata.jdbc.singlestore.SingleStoreDriver";
